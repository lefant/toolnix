...
let
  ...
  required = import ../../modules/shared/required-baseline.nix { inherit pkgs; };
  opinionated = import ../../modules/shared/opinionated-shell.nix { inherit pkgs; };
  agent = import ../../modules/shared/agent-baseline.nix { inherit pkgs lib; inputs = resolvedInputs; };
